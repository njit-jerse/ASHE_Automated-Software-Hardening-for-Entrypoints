...
/**
 * The {@code ApiRequestHandler} interface provides methods for interacting with an API. It defines
 * methods to create API requests and fetch API responses.
 */
public interface ApiRequestHandler {
   ...
   */
  HttpResponse<String> apiResponse(HttpRequest request, HttpClient client)
