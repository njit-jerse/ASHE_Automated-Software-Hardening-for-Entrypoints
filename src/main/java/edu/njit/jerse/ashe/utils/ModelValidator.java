...
public class ModelValidator {
   ...
   *
   * <p>The first model in this list is considered the default model for the application. This list
   * can be updated as needed to include new models or remove existing ones.
   *
   * <p>Example models include:
   *
   * <ul>
   *   <li>"gpt-4" - represents the {@link GptModel#GPT_4} model
   *   <li>"mock" - represents a mock model for testing or development purposes
   *   <li>"dryrun" - dryrun allows {@link Ashe#run} to run without a model, skipping the error
   *       correction process
   * </ul>
   *
  ...
  /**
   * Validates the provided model name against a pre-defined set of valid models. If the model name
   * is not in the list of valid models, an {@link IllegalArgumentException} is thrown.
   *
